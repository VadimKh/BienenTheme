        ...
        <div class="row">
            <div class="small-12 large-12 columns" role="main">
                ...
                <article class="post-47 page type-page status-publish hentry" id="post-47">
                    ...
                    <a class="button" data-dropdown="tinyDrop" href="#">Link Dropdown »</a>
                    ...
                    <div id="secondModal" class="reveal-modal" data-reveal="">
                        ...
                        <p>See? It just slides into place after the other first modal. Very handy when you need
                            subsequent dialogs, or when a modal option impacts or requires another decision.</p>
                        <a class="close-reveal-modal">×</a>
                    </div>
